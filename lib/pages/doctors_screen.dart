...
// Import the app's doctor models and sample data.
import 'package:booking_appointment_app/data/doctor_data.dart';
import 'package:booking_appointment_app/pages/doctor_details_screen.dart';
...
class DoctorsScreen extends StatefulWidget {
  ...
  @override
  State<DoctorsScreen> createState() => _DoctorScreenState();
}
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      _buildBadge('${doctor.patients} Patients'),
